    ...
    props: {
      children: [
        ...
        },
        {
          type: "div",
          props: {
            tw: "pl-10 shrink flex text-white text-3xl max-w-[450px]",
            children: [
              {
                type: "div",
                props: {
      ...
      style: {
        background: "linear-gradient(to bottom, rgb(50,54,98), rgb(30,30,30))",
      },
    },
  };
};
